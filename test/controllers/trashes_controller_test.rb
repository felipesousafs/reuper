...
class TrashesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trash" do
    assert_difference('Trash.count') do
      post trashes_url, params: { trash: { done: @trash.done, user_id: @trash.user_id, when: @trash.when } }
    end
  ...
  test "should update trash" do
    patch trash_url(@trash), params: { trash: { done: @trash.done, user_id: @trash.user_id, when: @trash.when } }
